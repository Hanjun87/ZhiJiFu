...
export const PostDetail: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20">
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-xl z-50 px-6 py-3 flex items-center justify-between shadow-sm">
      ...
      <main className="pt-20 px-6 max-w-3xl mx-auto space-y-8">
