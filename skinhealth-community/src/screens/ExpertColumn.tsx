...
export const ExpertColumn: React.FC = () => {
  const experts = [MOCK_USERS.doctor_lin, MOCK_USERS.prof_zhang];

  return (
    <div className="pb-24">
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-xl z-50 px-6 py-3 flex flex-col gap-4 shadow-sm">
