...
export const CreatePost = ({ onNavigate }: { onNavigate: (p: Page) => void }) => {
  return (
    <div className="bg-gray-50 h-full overflow-y-auto">
      <header className="sticky top-0 left-0 right-0 bg-white/80 backdrop-blur-xl z-50 px-6 h-16 flex items-center justify-between shadow-sm pt-8">
        <button onClick={() => onNavigate('community')} className="text-gray-500 font-medium">取消</button>
      ...
      <main className="pt-6 px-6 max-w-screen-md mx-auto space-y-8 pb-24">
