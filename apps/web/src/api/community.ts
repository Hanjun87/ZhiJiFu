...
const MOCK_POSTS: Post[] = [
  {
    ...
    images: getRandomPostImages(2, 1),
    tags: ['痤疮', '护肤心得', '祛痘印'],
    likes: 2345,
    comments: 567,
    shares: 123,
  ...
  },
  {
    ...
    images: getRandomPostImages(2, 4),
    tags: ['淡斑', '医美体验', '术后护理'],
    likes: 1234,
    comments: 456,
    shares: 178,
  },
  {
    ...
    images: getRandomPostImages(3, 5),
    tags: ['美白', '成分分析', '产品测评'],
    likes: 3456,
    comments: 678,
    shares: 456,
  },
  {
    ...
    images: getRandomPostImages(1, 6),
    tags: ['湿疹', '求助', '皮炎'],
    likes: 567,
    comments: 234,
    shares: 89,
  ...
  },
  {
    ...
    images: getRandomPostImages(2, 7),
    tags: ['成分分析', '护肤心得', '抗老'],
    likes: 2345,
    comments: 456,
    shares: 345,
  },
  {
    ...
    images: getRandomPostImages(2, 8),
    tags: ['防晒', '护肤打卡', '美白'],
    likes: 1567,
    comments: 234,
    shares: 123,
  ...
  },
  {
    ...
    images: getRandomPostImages(2, 9),
    tags: ['痤疮', '护肤打卡', '闭口'],
    likes: 890,
    comments: 123,
    shares: 67,
  },
  {
    ...
    images: getRandomPostImages(2, 10),
    tags: ['皮炎', '护肤心得', '玫瑰痤疮'],
    likes: 4567,
    comments: 890,
    shares: 567,
  },
  {
    ...
    images: getRandomPostImages(1, 11),
    tags: ['医美体验', '补水', '毛孔'],
    likes: 2345,
    comments: 456,
    shares: 234,
  },
  {
    ...
    images: getRandomPostImages(2, 12),
    tags: ['成分分析', '美白', '护肤心得'],
    likes: 3456,
    comments: 567,
    shares: 456,
